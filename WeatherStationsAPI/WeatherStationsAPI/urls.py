...
urlpatterns = [
    ...
    path('reports/<int:id>/remove_station/',views.remove_from_report,name='remove-station'),
    path('reports/<int:id>/put_temperature/',views.put_temperature,name='put-temperature'),
